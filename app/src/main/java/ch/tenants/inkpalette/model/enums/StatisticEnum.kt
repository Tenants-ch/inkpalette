...
enum class StatisticEnum(
    ...
    companion object {
        fun getEnumForAction(action: Action): StatisticEnum {
            return when (action) {
                Action.CONVERT -> BUTTON_CONVERT
                Action.UNLOCK -> BUTTON_UNLOCK
                Action.UPGRADE -> BUTTON_UNLOCK
                Action.COLLECT -> BUTTON_COLLECT
            }
        }
    }
}